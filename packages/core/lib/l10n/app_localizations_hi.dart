...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String greetings(String firstName, String lastName) {
    return 'हैलो $firstName $lastName';
  }
  ...
  String pluralMessage(num peoplesCount, Object count) {
    ...
    return 'कुल हैं $_temp0 मांद में';
  }
  ...
  String selectSample(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'he': 'पुरुष',
        'she': 'महिला',
        'other': 'उसे कोई जानकारी नहीं है',
      },
    );
    return 'व्यक्ति है $_temp0';
  }

  @override
  String get escapingTheInterpolation => 'नमस्ते, मैं जॉन कार्टर हूं {is n\'t}';
  ...
  String amountWithCompactCurrency(Object amount) {
    return 'आवेदन का वर्तमान बजट: $amount';
  }
  ...
  String currentDate(DateTime date) {
    ...
    return 'आज की तारीख़ : $dateString';
  }
