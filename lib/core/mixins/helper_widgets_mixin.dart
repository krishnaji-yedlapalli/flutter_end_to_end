...
mixin HelperWidget {
  ...
  Widget buildTitleWithExpandedContent(
      {required String title,
      required Widget content,
      bool hideBorder = false}) {
    return Builder(builder: (context) {
  ...
  Widget buildLabelWithValue(String label, String value,
      {String? des, bool isBorderRequired = false}) {
    return LayoutBuilder(builder: (context, constraints) {
      double maxWidth = DeviceConfiguration.isMobileResolution
  ...
  Widget get buildUnderDevelopmentMessage => Builder(builder: (context) {
        return Align(
