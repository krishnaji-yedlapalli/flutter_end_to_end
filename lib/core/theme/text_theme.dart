...
class AppTextTheme {
  static TextTheme getResponsiveTextTheme(BuildContext context) {
    ...
    double scaleFactor =
        ResponsiveUtils.getScaleFactor(context); // Using iPhone X width as base

    return TextTheme(
      displayLarge: TextStyle(
        fontSize: (Theme.of(context).textTheme.displayLarge?.fontSize ?? 32) *
            scaleFactor,
        fontWeight: FontWeight.bold,
      ),
      displayMedium: TextStyle(
        fontSize: (Theme.of(context).textTheme.displayMedium?.fontSize ?? 28) *
            scaleFactor,
        fontWeight: FontWeight.bold,
      ),
      ...
      headlineLarge: TextStyle(
        fontSize: (Theme.of(context).textTheme.headlineLarge?.fontSize ?? 22) *
            scaleFactor,
        fontWeight: FontWeight.w600,
      ),
      headlineMedium: TextStyle(
        fontSize: (Theme.of(context).textTheme.headlineMedium?.fontSize ?? 20) *
            scaleFactor,
        fontWeight: FontWeight.w600,
      ),
      headlineSmall: TextStyle(
        fontSize: (Theme.of(context).textTheme.headlineSmall?.fontSize ?? 18) *
            scaleFactor,
        fontWeight: FontWeight.w600,
      ),
