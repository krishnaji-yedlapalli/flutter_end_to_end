...
class AppColors {
  ...
  static final Color greenShade500 = Colors.green.shade500;
  static final Color blueAccentWithOpacity = Colors.blueAccent.withOpacity(0.5);
  static final Color greyWithOpacity = Colors.grey.withOpacity(0.1);
}
