...
extension DioRequestExtension on RequestOptions {
  ...
  bool get isOfflineApi =>
      extra.containsKey(DbConstants.isOfflineApi) &&
      extra[DbConstants.isOfflineApi];

  ///To check whether this request is Queue items
  bool get isFromQueueItem =>
      extra.containsKey(DbConstants.isFromQueue) &&
      extra[DbConstants.isFromQueue];

  ///Whether this request is required to store in local db or not
  bool get notRequiredToStoreInQueue =>
      extra.containsKey(DbConstants.notRequiredToStoreInQueue) &&
      extra[DbConstants.notRequiredToStoreInQueue];

  /// Get the Priority or else default is -1
  int get priority => extra.containsKey(DbConstants.priority)
      ? extra[DbConstants.priority]
      : -1;
  ...
  set notRequiredToStoreInQueue(bool status) =>
      extra[DbConstants.notRequiredToStoreInQueue] = status;
