...
@override
Future<SchoolDetailsEntity> addOrEditSchoolDetails(SchoolDetailsEntity schoolDetails) async {
  ...
  if(response != null && response is Map && response.keys.isNotEmpty) {
    schoolDetails = SchoolDetailsModel.fromJson(response[response.keys.first]).toEntity();
  }else{
