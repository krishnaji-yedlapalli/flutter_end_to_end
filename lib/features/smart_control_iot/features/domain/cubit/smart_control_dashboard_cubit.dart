...
class SmartControlDashboardCubit extends Cubit<ScDashboardState> {
  ...
  SmartControlDashboardCubit(
      this._smartDeviceStatusUseCase, this._smartDeviceControlUseCase)
  ...
  Future<void> loadSmartControlDashboard() async {
    ...
    for (var device in screenTypes) {
      cubitList[device.ipAddress] = SmartDeviceControlCubit(
          _smartDeviceStatusUseCase, _smartDeviceControlUseCase, device);
    }
