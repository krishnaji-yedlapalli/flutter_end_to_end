...
class DailyTrackerRouterModule {
  ...
  static const _dailyTrackerDashboardPage =
      '$_parentPath/daily-tracker-dashboard';

  static const logInPath = '${Routing.home}/$_loginPage';
  static const profilesPath = '${Routing.home}/$_profilesPage';
  static const dailyTrackerDashboardPath =
      '${Routing.home}/$_dailyTrackerDashboardPage';
      ...
      routes: [
        GoRoute(
            ...
            redirect: (context, state) async {
              ...
              if (await storage.containsKey(key: 'loginDetails') &&
                  (state.path?.contains(_loginPage) ?? false)) {
                return profilesPath;
              }
              return null;
            }),
