...
class FirebasePushNotifications extends StatefulWidget {
  ...
  @override
  State<FirebasePushNotifications> createState() =>
      _FirebasePushNotificationsState();
}
...
class _FirebasePushNotificationsState extends State<FirebasePushNotifications>
            ...
            Form(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: requestPushNotification,
  ...
  Future<String?> get registrationToken async {
    if (kIsWeb) {
      return await messaging.getToken(
          vapidKey:
              'BELYPbF8fCnMJeNmbTSl3uJbvXlKj3kG_C7XqYDvoYZuwrK7_EZ7RAgaHqD3MGkFveq6GlkYIYxuFlJlERf0oLo');
    } else {
    ...
    try {
      ...
      var body = {
        "message": {
          ...
          "data": {"path": pageCtrl.text.trim()}
        }
      };

      AuthClient? credentials;
      if (PushNotificationService.credentials == null) {
        PushNotificationService.credentials =
      ...
      var res = await BaseService.instance.makeRequest(
          url: 'v1/projects/flutter-end-to-end/messages:send',
      ...
      if (res != null && res['success'] == 1) {
        var snack =
            const SnackBar(content: Text('Successfully sent the message!!!'));
        ScaffoldMessenger.of(context).showSnackBar(snack);
      }
    } catch (e) {
      var snack =
  ...
  Future<AuthClient> obtainAuthenticatedClient() async {
    ...
    final accountCredentials = ServiceAccountCredentials.fromJson({
      ...
      "client_email":
          "firebase-adminsdk-a5ioe@flutter-end-to-end.iam.gserviceaccount.com",
