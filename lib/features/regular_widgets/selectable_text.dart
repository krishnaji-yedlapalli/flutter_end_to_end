      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Title(
                color: Colors.green,
                child: Text('Selectable Text Widget',
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Title(
                color: Colors.green,
                child: Text('Selectable Area Widget',
                    style: Theme.of(context).textTheme.titleMedium)),
          ),
          const Text(
              'Below is sample text, we selectable area widget we can select all the text'),
          const Text(
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Title(
                color: Colors.green,
                child: Text('Selectable Region Widget',
                    style: Theme.of(context).textTheme.titleMedium)),
          ),
          const Text(
              'Below is sample text, we selectable area widget we can select all the text'),
