...
class _MaterialComponentsState extends State<MaterialComponents>
    with HelperWidget {
  bool value = false;
  ...
  var segments = [
    const ButtonSegment<int>(
        ...
        tooltip: 'Hi there !!'),
    const ButtonSegment<int>(
        value: 1, label: Text('Hello'), tooltip: 'Hello there !!'),
    const ButtonSegment<int>(
        value: 2, label: Text('there'), tooltip: 'Hi Hello there !!')
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: !DeviceConfiguration.isMobileResolution
            ? SingleChildScrollView(
                child: Wrap(
                    ...
                    children:
                        List.generate(materialWidgets.length * 2 - 1, (index) {
                      if (index % 2 == 0) {
            ...
            : ListView.separated(
                itemBuilder: (context, index) =>
                    materialWidgets.elementAt(index),
                separatorBuilder: (context, index) => hDivider,
                itemCount: materialWidgets.length,
                shrinkWrap: true,
              ));
  }
  ...
  Widget _buildSegmentedButtons() {
    return buildTitleWithContent(
        ...
        content: SegmentedButton(
            ...
            onSelectionChanged: (Set<int> items) {
              setState(() {
  ...
  Widget _buildMultiSegmentedButtons() {
    return buildTitleWithContent(
        ...
        content: SegmentedButton<int>(
          segments: segments,
          selected: selectedMultiSegmentIndex,
          ...
          style:
              ButtonStyle(elevation: WidgetStateProperty.resolveWith((states) {
        ...
        content: Wrap(
          ...
          children: [
            ...
            FloatingActionButton.extended(
                onPressed: () {}, label: const Text('Extended !!!')),
            FloatingActionButton.large(
                onPressed: () {}, child: const Text('Large')),
            FloatingActionButton.small(
                onPressed: () {}, child: const Text('Small'))
          ],
        ));
  }
  ...
  Widget _buildSliders() {
    return buildTitleWithContent(
      title: 'Sliders',
      content: Wrap(direction: Axis.vertical, children: [
        SizedBox(
          width: 250,
  ...
  Widget _buildToolTips() {
    return buildTitleWithContent(
        title: 'Tool Tips',
        content: Wrap(direction: Axis.vertical, spacing: 10, children: [
          Tooltip(
              message: 'Tool tip 1',
              child: Text('Tool tip 1',
                  style: Theme.of(context).textTheme.titleSmall)),
          Tooltip(
              message:
                  'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam turpis mauris, scelerisque ac diam ac, tincidunt finibus felis. Phasellus blandit efficitur ligula a varius. Nam faucibus aliquam velit a bibendum. Nunc imperdiet augue quis imperdiet hendrerit. Vestibulum feugiat ipsum id elementum hendrerit. Integer eu leo at justo egestas convallis. Cras vitae euismod massa. Nunc pellentesque dictum auctor. Maecenas eget cursus velit, eget efficitur ipsum.',
              child: Text('Tool tip 2',
                  style: Theme.of(context).textTheme.titleSmall)),
        ]));
  }
